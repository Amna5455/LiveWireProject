...
class ChatBoxComponent extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            ...
            'loadConversation', 'pushMessage', 'loadmore', 'updateHeight', 'resetComponent','broadcastMessageRead'
        ];
    }
    ...
    function broadcastedMessageReceived($event)
    {
        ...
        // dd($event);
        ///here
        $this->emitTo('chat.chat-list-component', 'refresh');
        //     # code...
    ...
    {
        return view('livewire.chat.chat-box-component');
    }
}
